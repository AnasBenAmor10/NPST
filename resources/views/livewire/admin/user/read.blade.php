                ...
                <table class="table table-hover table-striped">
                    <thead>
                        <tr>
                            ...
                            <th scope="col" style='cursor: pointer' wire:click="sort('cin')"> <i class='fa @if($sortType == 'desc' and $sortColumn == 'cin') fa-sort-amount-down ml-2 @elseif($sortType == 'asc' and $sortColumn == 'cin') fa-sort-amount-up ml-2 @endif'></i> {{ __('Cin') }} </th>
